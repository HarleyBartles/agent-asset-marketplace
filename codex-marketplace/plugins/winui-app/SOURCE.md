...
This plugin packages the upstream OpenAI Skills root `skills/.curated/winui-app` as a market-facing Codex plugin.
...
- Status: `imported`
- Plugin name: `winui-app`
- Display name: `WinUI App`
