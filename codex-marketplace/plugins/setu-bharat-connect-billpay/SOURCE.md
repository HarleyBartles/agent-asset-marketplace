# Source
        ...
        This plugin packages the upstream OpenAI Plugins root `plugins/setu-bharat-connect-billpay` as a market-facing Codex plugin.
...
- `assets`
        ...
        - Status: `imported`
        - Plugin name: `setu-bharat-connect-billpay`
