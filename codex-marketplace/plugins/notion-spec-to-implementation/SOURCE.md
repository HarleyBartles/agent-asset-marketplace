...
This plugin packages the upstream OpenAI Skills root `skills/.curated/notion-spec-to-implementation` as a market-facing Codex plugin.
...
- Status: `imported`
- Plugin name: `notion-spec-to-implementation`
- Display name: `Spec to Implementation`
