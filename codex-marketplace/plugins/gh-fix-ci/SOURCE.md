...
This plugin packages the upstream OpenAI Skills root `skills/.curated/gh-fix-ci` as a market-facing Codex plugin.
...
- Status: `imported`
- Plugin name: `gh-fix-ci`
- Display name: `Gh Pr Checks Plan Fix`
