...
This plugin packages the upstream OpenAI Skills root `skills/.curated/vercel-deploy` as a market-facing Codex plugin.
...
- Status: `imported`
- Plugin name: `vercel-deploy`
- Display name: `Vercel Deploy`
