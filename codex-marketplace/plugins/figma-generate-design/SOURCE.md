...
This plugin packages the upstream OpenAI Skills root `skills/.curated/figma-generate-design` as a market-facing Codex plugin.
...
- Status: `imported`
- Plugin name: `figma-generate-design`
- Display name: `Build / Update Screens from Design System`
