...
- `writing` is the ordinary entrypoint for composed human-facing writing.
- `writing-with-clarity` owns factual fidelity, flow, directness, and final readability review.
- `writing-style` owns authorised voice and evidence-backed anti-fatigue profiles.
- `writing-profile-engine` evaluates writing-specific profiles with transparent, typed results.
