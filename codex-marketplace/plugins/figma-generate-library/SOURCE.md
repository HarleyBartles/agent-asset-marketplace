...
This plugin packages the upstream OpenAI Skills root `skills/.curated/figma-generate-library` as a market-facing Codex plugin.
...
- Status: `imported`
- Plugin name: `figma-generate-library`
- Display name: `Design System Builder — Figma MCP Skill`
