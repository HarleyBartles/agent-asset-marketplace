...
This plugin packages the upstream OpenAI Skills root `skills/.curated/jupyter-notebook` as a market-facing Codex plugin.
...
- Display name: `Jupyter Notebook Skill`
