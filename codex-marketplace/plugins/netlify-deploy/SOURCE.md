...
This plugin packages the upstream OpenAI Skills root `skills/.curated/netlify-deploy` as a market-facing Codex plugin.
...
- Display name: `Netlify Deployment Skill`
