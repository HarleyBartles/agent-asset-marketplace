...
This plugin packages the upstream OpenAI Skills root `skills/.curated/sentry` as a market-facing Codex plugin.
...
- Status: `imported`
- Plugin name: `openai-skills-sentry`
- Display name: `Sentry (Read-only Observability)`
