...
| Task | Load reference |
| --- | --- |
| Profile code and find bottlenecks | `references/profiling.md` |
| Algorithm and data structure optimization | `references/algorithms.md` |
| Memory optimization and generators | `references/memory.md` |
| String concatenation and file I/O | `references/string-io.md` |
| NumPy, Numba, Cython, multiprocessing | `references/acceleration.md` |
