...
- The retained `obra/superpowers` v6.3.0 MIT snapshot is recorded in `SOURCE.md` for reference; it is not the editable surface and no adapter overlay is applied.
