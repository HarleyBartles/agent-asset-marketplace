...
- Do not use this plugin as a dumping ground for ECC workflow doctrine; route that material through `ecc-superpowers` and the dedicated `superpowers-ecc` pack instead.
