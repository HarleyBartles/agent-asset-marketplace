...
Use only when the current human explicitly approves the legacy graph for a non-frontier or unknown-capability orchestrator. Frontier orchestrators do not use this workflow.
