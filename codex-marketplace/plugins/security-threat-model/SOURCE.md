...
This plugin packages the upstream OpenAI Skills root `skills/.curated/security-threat-model` as a market-facing Codex plugin.
...
- Status: `imported`
- Plugin name: `security-threat-model`
- Display name: `Threat Model Source Code Repo`
