...
This plugin packages the upstream OpenAI Skills root `skills/.system/skill-installer` as a market-facing Codex plugin.
...
- Status: `imported`
- Plugin name: `skill-installer`
- Display name: `Skill Installer`
