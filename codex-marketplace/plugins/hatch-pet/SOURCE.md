...
This plugin packages the upstream OpenAI Skills root `skills/.curated/hatch-pet` as a market-facing Codex plugin.
...
- Status: `imported`
- Plugin name: `hatch-pet`
- Display name: `Hatch Pet`
