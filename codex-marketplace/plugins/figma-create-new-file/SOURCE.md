...
This plugin packages the upstream OpenAI Skills root `skills/.curated/figma-create-new-file` as a market-facing Codex plugin.
...
- Status: `imported`
- Plugin name: `figma-create-new-file`
- Display name: `create_new_file — Create a New Figma File`
