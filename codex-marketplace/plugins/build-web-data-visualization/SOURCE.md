# Source
        ...
        This plugin packages the upstream OpenAI Plugins root `plugins/build-web-data-visualization` as a market-facing Codex plugin.
...
- `skills`
        ...
        - Status: `imported`
        - Plugin name: `build-web-data-visualization`
