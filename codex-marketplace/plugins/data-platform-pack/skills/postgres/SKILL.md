...
> Use when working with PostgreSQL databases and you need schema, indexing, query, connection, or operations guidance.
...
| Query Patterns         | [references/query-patterns.md](references/query-patterns.md) | SQL anti-patterns, JOINs, pagination, and batch queries |
| Optimization Checklist | [references/optimization-checklist.md](references/optimization-checklist.md) | Pre-optimization audit, cleanup, and readiness checks |
| MVCC and VACUUM        | [references/mvcc-vacuum.md](references/mvcc-vacuum.md) | Dead tuples, long transactions, and xid wraparound prevention |
