...
metadata:
  ...
  source-path: codex-marketplace/plugins/house-skills/skills/invariant-buster/SKILL.md
...
- `green` — the move preserves the binding invariants.
- `amber` — an invariant may be implicated and needs repair, explicit assumption, or lawful decision.
- `red` — the move would violate a known invariant.
- `blocked` — the invariant source or authority needed to judge the move is unavailable.
