...
metadata:
  ...
  source-path: codex-marketplace/plugins/house-skills/skills/rooms-zoom-outs-buster/SKILL.md
...
6. If the model is a persistence candidate, compose with `rooms-source-partitioning-v1`, `canon-buster-v1`,
`rooms-ambiguity-buster-v1`, and `invariant-buster-v1` before dispatch or canon/world persistence.
