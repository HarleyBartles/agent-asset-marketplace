...
- Historical source id: `session-buster-ingress-v0.2`
- Current root: `codex-marketplace/plugins/house-skills/skills/session-buster-ingress/SKILL.md`
- Provenance: historical archive note for session-buster-ingress
