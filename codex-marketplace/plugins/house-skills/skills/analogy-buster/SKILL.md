...
metadata:
  ...
  source-path: codex-marketplace/plugins/house-skills/skills/analogy-buster/SKILL.md
...
- `green` — the analogy clarifies the specific question within stated limits, or is unnecessary and can be safely discarded.
