...
| Base and control plane | boring-loop | `sources/first_party/core/boring-loop` |
...
| Base and control plane | cleanup-custody | `sources/first_party/core/cleanup-custody` |
| Base and control plane | connector-safety | `sources/first_party/core/connector-safety` |
...
| Base and control plane | skill-packager | `sources/first_party/core/skill-packager` |
| Base and control plane | skill-validator | `sources/first_party/core/skill-validator` |
...
| Base and control plane | skill-installer | `sources/first_party/core/skill-installer` |
...
| Base and control plane | bootstrap-router | `sources/first_party/core/bootstrap-router` |
