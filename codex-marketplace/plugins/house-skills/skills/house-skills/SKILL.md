...
- the `github-operations`, `github-superpowers`, `asset-market`, `linear-issue-shaping`, `linear-superpowers`, and `boring-loop` roots that now live as current control-plane skills;
