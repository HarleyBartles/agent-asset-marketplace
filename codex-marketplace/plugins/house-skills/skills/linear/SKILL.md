...
- Use `linear-issue-shaping` for issue-to-Codex routing, worker-state checks, human `Create PR` gate handling, and deciding whether a task is Codex Cloud-executable.
