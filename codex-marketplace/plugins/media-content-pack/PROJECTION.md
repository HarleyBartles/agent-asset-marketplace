...
This root is the Codex-facing marketplace projection of selected ECC media/content skills from MARK-252/255.

## Layer Model

This repository uses two distinct layers for the ECC Media Content bundle:
...
- `media-content-pack` is the third-party plugin projection with ECC media/content skills selected for MARK-252/255.
- The active plugin contains two ECC skills: `fal-ai-media` and `seo`.
...
- Other ECC skills not selected for MARK-252/255 remain in the source custody only.
