...
This plugin packages the upstream OpenAI Skills root `skills/.curated/cli-creator` as a market-facing Codex plugin.
...
- Status: `imported`
- Plugin name: `cli-creator`
- Display name: `CLI Creator`
