# Source
        ...
        This plugin packages the upstream OpenAI Plugins root `plugins/particl-market-research` as a market-facing Codex plugin.
...
- `assets`
        ...
        - Status: `imported`
        - Plugin name: `particl-market-research`
