...
This plugin packages the upstream OpenAI Skills root `skills/.curated/playwright-interactive` as a market-facing Codex plugin.
...
- Status: `imported`
- Plugin name: `playwright-interactive`
- Display name: `Playwright Interactive Skill`
