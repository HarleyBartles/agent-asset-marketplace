...
This plugin packages the upstream OpenAI Skills root `skills/.curated/figma-implement-design` as a market-facing Codex plugin.
...
- Status: `imported`
- Plugin name: `figma-implement-design`
- Display name: `Implement Design`
