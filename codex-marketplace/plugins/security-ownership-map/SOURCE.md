...
This plugin packages the upstream OpenAI Skills root `skills/.curated/security-ownership-map` as a market-facing Codex plugin.
...
- Status: `imported`
- Plugin name: `security-ownership-map`
- Display name: `Security Ownership Map`
