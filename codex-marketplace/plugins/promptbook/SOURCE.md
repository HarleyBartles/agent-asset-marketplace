...
This bundle packages the upstream `promptbook` package as a market-facing Codex plugin.
...
- `plugins/business-tools/promptbook/skills` functional package root

## Outcome

- Candidate skills found: `2`
- Imported into this pack: `2`
...
`codex-marketplace/plugins/promptbook/references/bundle-manifest.json`.
