...
This plugin packages the upstream OpenAI Skills root `skills/.curated/figma-code-connect-components` as a market-facing Codex plugin.
...
- Status: `imported`
- Plugin name: `figma-code-connect-components`
- Display name: `Code Connect Components`
