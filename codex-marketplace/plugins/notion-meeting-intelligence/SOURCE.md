...
This plugin packages the upstream OpenAI Skills root `skills/.curated/notion-meeting-intelligence` as a market-facing Codex plugin.
...
- Status: `imported`
- Plugin name: `notion-meeting-intelligence`
