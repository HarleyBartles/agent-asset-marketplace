...
This plugin packages the upstream OpenAI Skills root `skills/.curated/define-goal` as a market-facing Codex plugin.
...
- Status: `imported`
- Plugin name: `define-goal`
- Display name: `Define Goal`
