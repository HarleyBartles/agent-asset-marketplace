...
This plugin packages the upstream OpenAI Skills root `skills/.curated/notion-research-documentation` as a market-facing Codex plugin.
...
- Status: `imported`
- Plugin name: `notion-research-documentation`
- Display name: `Research & Documentation`
