...
This plugin packages the upstream OpenAI Skills root `skills/.curated/notion-knowledge-capture` as a market-facing Codex plugin.
...
- Status: `imported`
- Plugin name: `notion-knowledge-capture`
- Display name: `Knowledge Capture`
