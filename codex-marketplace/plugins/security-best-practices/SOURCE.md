...
This plugin packages the upstream OpenAI Skills root `skills/.curated/security-best-practices` as a market-facing Codex plugin.
...
- Status: `imported`
- Plugin name: `security-best-practices`
