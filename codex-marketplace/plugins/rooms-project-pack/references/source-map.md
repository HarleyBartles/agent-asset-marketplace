...
| rooms-risk-gates | first_party | verbatim | `sources/first_party/skills/rooms-risk-gates` | `codex-marketplace/plugins/rooms-project-pack/skills/rooms-risk-gates` | First-party skill projected verbatim into the rooms-project-pack. Rooms-specific risk gate overlay composing with the base risk-gates skill. |
