...
| risk-gates | first_party | verbatim | `sources/first_party/skills/risk-gates` | `codex-marketplace/plugins/rooms-project-pack/skills/risk-gates` | First-party skill projected verbatim into the rooms-project-pack. Replaces the retired rooms-ambiguity-buster, rooms-analogy-buster, rooms-canon-buster, and rooms-zoom-outs-buster gate overlays. |
