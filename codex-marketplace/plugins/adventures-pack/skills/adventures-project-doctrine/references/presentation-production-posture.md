...
stop unless Harley explicitly approves a mode change.

Image generation credits are scarce production capacity. For proof/full/final-candidate body-slide scene art, image
generation is mandatory only at the proper playbook image stage unless Harley explicitly starts storyboard/draft mode.
...
After a GPT-side generation call, stop. If Harley asks for QA, run Patch or Adventures image QA and return
