...
This plugin packages the upstream OpenAI Skills root `skills/.curated/figma-use` as a market-facing Codex plugin.
...
- Status: `imported`
- Plugin name: `figma-use`
- Display name: `use_figma — Figma Plugin API Skill`
