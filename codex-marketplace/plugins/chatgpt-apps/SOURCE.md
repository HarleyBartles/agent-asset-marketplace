...
This plugin packages the upstream OpenAI Skills root `skills/.curated/chatgpt-apps` as a market-facing Codex plugin.
...
- Status: `imported`
- Plugin name: `chatgpt-apps`
- Display name: `ChatGPT Apps`
