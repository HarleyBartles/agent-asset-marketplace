---
name: risk-gates
description: Use when a pre-action risk gate is needed before a mutation, dispatch, canon claim, analogy reliance, or resolution that could violate scope, authority, source truth, canon, safety, or user intent.
metadata:
