...
This plugin projects the retained Codex Cortex skills only.
...
- `sources/third_party/claude-cortex/upstream/skills/openapi-specification/`
...
## Boundary
- Only the retained Codex Cortex skills are projected.
