...
MARK-200 `event-driven-architecture` import, and the MARK-201
`database-design-patterns` import as the retained third-party custody surface
for the Claude-Cortex import.
...
`generated/skill-zips/codex-cortex/database-design-patterns/skill.zip`, and can
be installed directly from those artifacts.
