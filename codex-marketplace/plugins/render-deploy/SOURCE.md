...
This plugin packages the upstream OpenAI Skills root `skills/.curated/render-deploy` as a market-facing Codex plugin.
...
- Status: `imported`
- Plugin name: `render-deploy`
- Display name: `Deploy to Render`
