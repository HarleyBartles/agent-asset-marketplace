...
This plugin packages the upstream OpenAI Skills root `skills/.curated/cloudflare-deploy` as a market-facing Codex plugin.
...
- Status: `imported`
- Plugin name: `cloudflare-deploy`
- Display name: `Cloudflare Deploy`
