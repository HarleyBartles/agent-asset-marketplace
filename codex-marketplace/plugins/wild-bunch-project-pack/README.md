...
- The pack keeps only the Wild Bunch bridge/native skills; dependency plugins stay separate install surfaces.
- The pack does not retain a blocked placeholder entry.
