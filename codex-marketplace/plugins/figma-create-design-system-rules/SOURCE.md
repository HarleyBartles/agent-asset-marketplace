...
This plugin packages the upstream OpenAI Skills root `skills/.curated/figma-create-design-system-rules` as a market-facing Codex plugin.
...
- Status: `imported`
- Plugin name: `figma-create-design-system-rules`
- Display name: `Create Design System Rules`
