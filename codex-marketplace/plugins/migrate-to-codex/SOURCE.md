...
This plugin packages the upstream OpenAI Skills root `skills/.curated/migrate-to-codex` as a market-facing Codex plugin.
...
- Status: `imported`
- Plugin name: `migrate-to-codex`
- Display name: `Migrate to Codex`
