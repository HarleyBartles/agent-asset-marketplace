...
This plugin packages the upstream OpenAI Skills root `skills/.curated/gh-address-comments` as a market-facing Codex plugin.
...
- Status: `imported`
- Plugin name: `gh-address-comments`
- Display name: `PR Comment Handler`
