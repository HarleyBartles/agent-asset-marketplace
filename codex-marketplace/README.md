...
The marketplace currently offers **19 plugins** with **78 bundled skills**. The
...
| repo-worker-pack | Productivity | 10 | base-doctrine, cleanup-custody, connector-safety, context-safety, generating-agent-mesh, linear-issue-shaping, refreshing-installed-skills, repo-standards, repo-worker-base, risk-gates |
