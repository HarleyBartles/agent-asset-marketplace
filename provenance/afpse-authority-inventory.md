...
| MARK-346 | `dotnet` | skills-with-citation | `dotnet-pack` | `dotnet-claude-kit` `modern-csharp`, `ef-core`, `testing`, `clean-architecture`, `ddd`, `vertical-slice` | `harleydbartles/mark-346-create-the-first-party-net-ecosystem-skill-and-migrate` |
| MARK-347 | `typescript` | skills-with-citation | `language-patterns-pack` | `claude-cortex` `typescript-advanced-patterns` | `harleydbartles/mark-347-create-the-first-party-typescript-ecosystem-skill` |
| MARK-348 | `react` | skills-with-citation | `frontend-pack` | `claude-cortex` `react-performance-optimization` | `harleydbartles/mark-348-create-the-first-party-react-ecosystem-skill` |
