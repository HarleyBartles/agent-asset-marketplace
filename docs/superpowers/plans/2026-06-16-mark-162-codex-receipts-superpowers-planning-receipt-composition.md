...
- [ ] **Step 1: Read the existing first-party projection pattern**
...
- [ ] **Step 2: Add `codex-receipts-superpowers` to the bundle docs**
...
- [ ] **Step 3: Keep the composition boundary narrow**
...
- [ ] **Step 1: Write the failing source shape first**
...
- [ ] **Step 2: Compose the required workflows**
...
- [ ] **Step 3: Note any GPT overlay/export decision**
...
- [ ] **Step 2: Capture the implementation record**
...
- [ ] **Step 3: Confirm publication state**
