...
- [ ] **Step 1: Write the new skill source**
...
- [ ] **Step 1: Register the new first-party source in the ledgers**
...
- [ ] **Step 2: Update the bundle inventory**
...
- [ ] **Step 3: Record provenance cleanly**
...
- [ ] **Step 1: Verify whether a clean projection path already exists**
...
- [ ] **Step 2: Project only if the path is clean**
...
- [ ] **Step 3: Otherwise leave Superpowers untouched**
