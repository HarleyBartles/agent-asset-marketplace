...
- [ ] **Step 1: Add an upstream discovery fallback rule near the retry posture section**
...
- [ ] **Step 2: Preserve the existing discovery-before-mutation, post-create read-chain, and retry guidance**
