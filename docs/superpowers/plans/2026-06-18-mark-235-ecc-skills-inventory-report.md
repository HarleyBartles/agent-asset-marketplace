...
- [ ] **Step 1: Confirm the upstream `main` SHA and skill count**
...
- [ ] **Step 2: Extract per-skill descriptions from front matter**
...
- [ ] **Step 3: Classify skills into the required relevance buckets**
...
- [ ] **Step 1: Build the markdown inventory report**
...
- [ ] **Step 2: Keep the report concise and reviewer-friendly**
...
- [ ] **Step 2: Validate the repo change**
...
- [ ] **Step 3: Commit, push, and open the draft PR**
