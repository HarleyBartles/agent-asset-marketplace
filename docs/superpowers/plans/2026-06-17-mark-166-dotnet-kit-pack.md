...
**Architecture:** Keep the upstream snapshot selective and source-oriented, keep the first-party ledger separate from the pack surface, and project the six adapted skills into a standalone plugin root with bundle manifest and source map. The pack root documents the boundary; the skills hold the adapted guidance; generated zips prove installability.

**Tech Stack:** PowerShell file operations, Markdown skill docs, JSON manifests, marketplace validation, `py -3 tools/update_skill_artifacts.py`.

---

### Task 1: Materialize the selective upstream snapshot and first-party ledger

**Files:**
- Create: `sources/third_party/dotnet-claude-kit/upstream/README.md`
- Create: `sources/third_party/dotnet-claude-kit/upstream/LICENSE`
- Create: `sources/third_party/dotnet-claude-kit/upstream/CLAUDE.md`
- Create: `sources/third_party/dotnet-claude-kit/upstream/.mcp.json`
- Create: `sources/third_party/dotnet-claude-kit/upstream/.claude-plugin/plugin.json`
- Create: `sources/third_party/dotnet-claude-kit/upstream/.claude-plugin/marketplace.json`
- Create: `sources/third_party/dotnet-claude-kit/upstream/skills/modern-csharp/SKILL.md`
- Create: `sources/third_party/dotnet-claude-kit/upstream/skills/vertical-slice/SKILL.md`
- Create: `sources/third_party/dotnet-claude-kit/upstream/skills/clean-architecture/SKILL.md`
- Create: `sources/third_party/dotnet-claude-kit/upstream/skills/ddd/SKILL.md`
- Create: `sources/third_party/dotnet-claude-kit/upstream/skills/ef-core/SKILL.md`
- Create: `sources/third_party/dotnet-claude-kit/upstream/skills/testing/SKILL.md`
- Create: `sources/first_party/skills/dotnet-kit/decisions.md`
...
```powershell
Get-ChildItem sources/third_party/dotnet-claude-kit/upstream -Recurse | Select-Object FullName
```

Expected: only the retained upstream evidence files and the six selected skill sources.

### Task 2: Build the `dotnet-kit` marketplace pack

**Files:**
- Create: `codex-marketplace/plugins/dotnet-kit/.codex-plugin/plugin.json`
- Create: `codex-marketplace/plugins/dotnet-kit/README.md`
- Create: `codex-marketplace/plugins/dotnet-kit/SOURCE.md`
- Create: `codex-marketplace/plugins/dotnet-kit/LICENSE`
- Create: `codex-marketplace/plugins/dotnet-kit/assets/icon.svg`
- Create: `codex-marketplace/plugins/dotnet-kit/references/bundle-manifest.json`
- Create: `codex-marketplace/plugins/dotnet-kit/references/source-map.md`
- Create: `codex-marketplace/plugins/dotnet-kit/skills/modern-csharp/SKILL.md`
- Create: `codex-marketplace/plugins/dotnet-kit/skills/vertical-slice/SKILL.md`
- Create: `codex-marketplace/plugins/dotnet-kit/skills/clean-architecture/SKILL.md`
- Create: `codex-marketplace/plugins/dotnet-kit/skills/ddd/SKILL.md`
...
### Task 3: Register the pack in marketplace surfaces
...
Expected: registry validation passes for the new pack and still reports any unrelated pre-existing drift separately.
