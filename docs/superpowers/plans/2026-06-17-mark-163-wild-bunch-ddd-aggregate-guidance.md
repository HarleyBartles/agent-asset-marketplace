...
- [ ] **Step 1: Replace route-metaphor wording with DDD Aggregate Root language**

- [ ] **Step 2: Make `GameSession` the explicit live-play Aggregate Root and require external live-play commands to mutate through it**

- [ ] **Step 3: State that owned aggregate/component files may own cohesive state, behavior, invariants, and lifecycle transitions**

- [ ] **Step 4: Explicitly reject policy/coordinator/resolver-only extraction as aggregate work**
...
- [ ] **Step 1: Mirror the canonical house-skill wording exactly where the project pack copies are projected verbatim**

- [ ] **Step 2: Verify the mirrored copies stay byte-aligned with the canonical source**
...
- [ ] **Step 1: Rebuild the four affected skill zips with `py -3 tools/update_skill_artifacts.py --skill <pack>/<skill>`**

- [ ] **Step 2: Run marketplace validation and targeted search validation for remaining `aggregate route` text**

- [ ] **Step 3: Review the diff for accidental scope drift before committing**
