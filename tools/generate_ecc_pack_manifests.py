...
PACKS: list[dict[str, Any]] = [
    {
        ...
        "is_mega_pack": False,
        "notes": [
            "Repo worker base bundle combines first-party repo hygiene skills with the selected ECC search-first skill.",
            "The bundle keeps the first-party core intact while projecting the complementary ECC search workflow into the same home.",
        ],
        "source_ledger": [
        ...
        "entries": [
            ...
            _entry(
                ...
                provenance_note="Projected verbatim from retained ECC custody as a complementary repo-first research skill.",
