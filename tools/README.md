...
`py -3 tools/update_skill_artifacts.py --all` performs a full reconciliation across the marketplace manifests, repo index, pack manifests, mega-pack manifests, proof maps, projection, and generated skill zips before validating the registry.
