...
DEFAULT_REPO_INDEX = {
    ...
    "zones": [
        ...
        },
        {
            ...
            "purpose": "Retained third-party source custody for the promoted ECC upstream skills inventory and adoption-target notes. The durable custody shape is the ECC skills tree, not the whole upstream package surface.",
            "surface_kind": "vendored",
            "nearest_scoped_agents_md": "sources/third_party/AGENTS.md",
            "guidance_scope": "repo-owned-guidance",
