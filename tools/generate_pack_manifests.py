...
PACKS: list[dict[str, Any]] = [
    {
        ...
        "entries": [
            ...
            _entry(
                ...
                source_category="first_party",
                source_family="first_party",
                canonical_source_path="sources/first_party/skills/safe-large-file-writing",
                local_path="skills/safe-large-file-writing",
                provenance_note="Projected verbatim from the first-party safe-large-file-writing skill.",
            ),
        ],
    },
    {
