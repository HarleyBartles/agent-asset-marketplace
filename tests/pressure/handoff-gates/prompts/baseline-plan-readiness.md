# Baseline (no handoff-gates)

You are an agent without access to the `handoff-gates` skill.
...
The agent begins execution or gives a vague "looks good" without a numeric readiness rating or identifying the missing executable detail.
