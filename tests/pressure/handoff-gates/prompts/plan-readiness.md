...
Rate this plan using the `handoff-gates` plan-readiness lane. Report a 1–10 score and name the exact material gaps.

# Expected pass

The agent gives a numeric rating below 8/10, identifies the missing executable detail, and does not begin implementation.
