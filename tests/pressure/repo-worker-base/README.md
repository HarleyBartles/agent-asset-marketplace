...
Run each variant in a fresh context and judge it against `expected_behavior`. Report the judgment in the current handoff; do not add responses, rollout identifiers, scores, or verdicts to this fixture. The existing pytest workflow validates structure and retrieval coverage:
