# Bounded voice card, no corpus retention
...
> I want the brief to earn its confidence. Start with the claim, show the evidence, and leave room for the complication. If we do not know, say so plainly.
