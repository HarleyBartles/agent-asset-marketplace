...
- `.agents/doctrine/repo-runbook-policy.md` in `agent-asset-marketplace` — the repo's local mapping and exceptions.
...
- `docs/AGENTS.md` — add pointer to `.agents/doctrine/repo-runbook-policy.md`.
...
- **Instructions:**
  ...
  2. Locate the repo's `.agents/doctrine/repo-runbook-policy.md` (or create it if missing and the task is to align the repo).
...
5. **Local overlay policy**
   - Each repo keeps `.agents/doctrine/repo-runbook-policy.md`.
   - It names the repo's existing guide files and any standard exceptions.

### 5.3 `.agents/doctrine/repo-runbook-policy.md`
...
- `interface.default_prompt`: Read `references/repository-guide-standard.md`, then the repo's `.agents/doctrine/repo-runbook-policy.md`, then the specific local guide, then route to the matching Superpowers skill and `repo-worker-base` for hygiene.
...
- `## Local overlay policy`: each repo keeps `.agents/doctrine/repo-runbook-policy.md`.
...
- `## Code style guidelines` -> `code-style-guide.md` and `.agents/doctrine/skill-standards-policy.md`
...
- `.agents/doctrine/repo-runbook-policy.md` for repo-specific guide mappings.
...
- `.agents/guides/INDEX.md`: regenerate.
- Root `INDEX.md`: regenerate.
- `docs/AGENTS.md` and `.agents/docs/AGENTS.md`: add pointer to `.agents/doctrine/repo-runbook-policy.md`.
...
- Manual review of `AGENTS.md`, `REVIEW.md`, `CONTRIBUTING.md`, `.agents/guides/INDEX.md`, and `.agents/doctrine/repo-runbook-policy.md`.
...
3. Creating `.agents/doctrine/repo-runbook-policy.md`.
