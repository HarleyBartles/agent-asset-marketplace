...
The canonical skill source lives under `codex-marketplace/plugins/<plugin>/skills/`; third-party upstream provenance is recorded per pack in `codex-marketplace/plugins/<plugin>/SOURCE.md`.
