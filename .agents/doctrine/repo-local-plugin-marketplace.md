...
- Do not hand-maintain copied `.agents/skills/` folders for plugin-supplied skills.
- Default-install the repo worker posture plugins:
  - `repo-worker-pack`
  - `superpowers-plus`
- Do not make `house-skills` a repo-local marketplace dependency or default-install.
