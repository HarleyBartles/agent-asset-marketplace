...
- [x] **Step 1: Rename the source directory with git mv**
...
- [x] **Step 2: Write the new `SKILL.md`**
...
- [x] **Step 3: Write the new `agents/openai.yaml`**
...
- [x] **Step 4: Update the generated INDEX.md footer line**
...
- [x] **Step 1: Write `validate_agent_mesh.py`**
...
- [x] **Step 2: Write the bash wrapper `validate-agent-mesh.sh`**
...
- [x] **Step 3: Write the PowerShell wrapper `validate-agent-mesh.ps1`**
...
- [x] **Step 4: Smoke test the new core**
...
- [x] **Step 1: Update `codex-marketplace/custody-pack-registry.json`**
...
- [x] **Step 2: Update `refreshing-installed-skills/SKILL.md`**
...
- [x] **Step 3: Update `refreshing-installed-skills/scripts/refresh_installed_skills.py`**
...
- [x] **Step 4: Write the new `repo-standards/templates/ci-preflight.sh`**
...
- [x] **Step 5: Write the new `repo-standards/templates/ci-preflight.ps1`**
...
- [x] **Step 6: Update `tools/rebuild_marketplace.py`**
...
- [x] **Step 7: Update `tools/AGENTS.md`**
...
- [x] **Step 2: Run the failing-case test only (the source-repo test needs regenerated indexes first)**
...
- [x] **Step 1: Scaffold the root `scripts/ci-preflight.*` from the updated templates**
...
- [x] **Step 2: Regenerate the marketplace**
...
- [x] **Step 3: Run the marketplace check**
...
- [x] **Step 4: Run `validate-agent-mesh` on the source repo**
...
- [x] **Step 6: Stage and commit the full change**
