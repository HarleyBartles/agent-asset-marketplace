...
- `.agents/docs/repo-guide-policy.md` — repo-local guide mapping overlay.
...
interface:
  ...
  default_prompt: Read references/repository-guide-standard.md, then the repo's .agents/docs/repo-guide-policy.md, then the specific local guide. Use repo-worker-base for worktree, branch, validation, and publication. Route to the matching Superpowers skill for the stage.
policy:
...
**Files:**
- Create: `.agents/docs/repo-guide-policy.md`
- Modify: `.agents/docs/AGENTS.md`
- Modify: `docs/AGENTS.md`

- [x] **Step 1: Create `.agents/docs/repo-guide-policy.md` with exact content**
...
```bash
git add .agents/docs/repo-guide-policy.md .agents/docs/AGENTS.md docs/AGENTS.md
git commit -m "Add repo-guide-policy and wire scoped AGENTS.md routing."
```
...
2. `/repo-worker-base`
3. `.agents/docs/repo-guide-policy.md`
