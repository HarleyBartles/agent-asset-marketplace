...
| 2 | Ergonomic and reliability improvements | done | [Plan 2](./2026-08-09-plan-2-ergonomic-improvements.md) | c0b2cd39 | #288 | — | Plan implemented; archived. |
...
| 4 | TDD and fast-fix churn reduction | done | [Plan 4](./2026-08-10-plan-4-tdd-fast-fix.md) | 990fa8c6 | #290 | 9/10 | TDD mandate added to `implementer`/`implementer-strong` and `subagent-driven-development`; `finding-fix`/`fast-fix` recipes require RED/GREEN; `compile_metrics.py` tracks `findings_discovered_at_fix_nodes` and `regressions_introduced` with tests; generated surfaces synced. |
