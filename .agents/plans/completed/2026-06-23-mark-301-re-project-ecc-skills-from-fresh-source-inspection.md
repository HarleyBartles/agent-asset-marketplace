...
- Inspect: `.agents/contracts/openai-agent-yaml.md`
- Inspect: `.agents/contracts/skill-frontmatter.md`
...
- the file parses as YAML and satisfies the current contract in `.agents/contracts/openai-agent-yaml.md`
