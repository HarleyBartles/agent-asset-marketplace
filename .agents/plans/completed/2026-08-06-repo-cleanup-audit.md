...
- Re-point: `.devin/rules/contracts.md` to `.agents/contracts/`
...
- [x] **Step 2:** Edit `.devin/rules/docs.md` and `.devin/rules/contracts.md` to route to `.agents/docs/` and `.agents/contracts/`.
- [x] **Step 3:** Edit `.gitignore` to remove the `generated/*` block.
- [x] **Step 4:** Edit `docs/skill-standards-policy.md` to remove the `docs/overlay-adapter-policy.md` reference and update `docs/contracts/*` links to `.agents/contracts/*`.
...
**Files:**
- Move to `.agents/docs/`:
  - `docs/contracts/` → `.agents/contracts/`
...
- [x] **Step 1:** `git mv docs/contracts .agents/contracts`
