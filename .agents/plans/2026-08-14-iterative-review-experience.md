...
- [ ] **Step 1: Write `reviewer-fast.md` lens profile**
...
- [ ] **Step 2: Re-purpose `orchestrator-self-review` into `reviewer-fast`**
...
- [ ] **Step 3: Update `select_lenses.py`**
...
- [ ] **Step 4: Update `review-state-graph.md` and `SKILL.md`**
...
- [ ] **Step 1: Extend `normalize_review_inputs.py` to gather scope inputs**
...
- [ ] **Step 2: Write `check_scope_honesty.py`**
...
- [ ] **Step 3: Update `node-scope-honesty.md` recipe**
...
- [ ] **Step 4: Update `next_node.py` and `SKILL.md`**
...
- [ ] **Step 1: Add `--data-file <path>` support to all four scripts**
...
- [ ] **Step 2: Improve `--help` output to show the required schema**
...
- [ ] **Step 3: Update `SKILL.md` examples**
...
- [ ] **Step 1: Audit every `node-*.md` recipe**
...
- [ ] **Step 2: Fix the `reviewer-fixes` vs `resolved-ledger` resolution recording conflict**
...
- [ ] **Step 3: Fix the `new_issue` -> `metrics-track` routing bug**
...
- [ ] **Step 1: Add a `--resync` flag to `next_node.py` and/or `start_review.py`**
...
- [ ] **Step 2: Make `compile_metrics.py` derive `head_sha` from `review-state.json` and `review-metrics.json`**
...
- [ ] **Step 3: Update `SKILL.md` quick-start and node recipes**
...
- [ ] **Step 1: Standardize the `reviewer-fixes` output file and status line**
...
- [ ] **Step 2: Make `select_lenses.py` (or a helper) re-select the originating lens for `reviewer-fixes`**
...
- [ ] **Step 1: Regenerate installed skill copies**
...
- [ ] **Step 2: Commit the regenerated installed copies and provenance**

Commit with the canonical pre-commit hooks.

- [ ] **Step 3: Run `iterative-review` on PR #295 again from the new worktree**
