...
- [ ] **Step 3:** Edit `docs/skill-standards-policy.md` to remove the `docs/overlay-adapter-policy.md` reference and update `docs/contracts/*` links to `.agents/docs/contracts/*`.
...
- [ ] **Step 3:** `git mv docs/custody-and-marketplace-doctrine.md .agents/doctrine/`
- [ ] **Step 4:** `git mv docs/non-repo-locations-policy.md .agents/doctrine/`
- [ ] **Step 5:** `git mv docs/skill-standards-policy.md .agents/doctrine/`
...
- [ ] **Step 1:** `git mv .agents/docs/mesh-policy.md .agents/doctrine/`
- [ ] **Step 2:** `git mv .agents/docs/repo-runbook-policy.md .agents/doctrine/`
- [ ] **Step 3:** `git mv .agents/docs/repo-local-plugin-marketplace.md .agents/doctrine/`
- [ ] **Step 4:** `git mv .agents/docs/marketplace-worker-doctrine.md .agents/doctrine/`
- [ ] **Step 5:** `git mv .agents/docs/project-gate-over-plugin-flattening.md .agents/doctrine/`
...
- [ ] **Step 1:** Search for `docs/` references in the above files and rewrite to `.agents/docs/` or `.agents/doctrine/` as appropriate (e.g. `docs/contracts/*` → `.agents/docs/contracts/*`, `docs/skill-standards-policy.md` → `.agents/doctrine/skill-standards-policy.md`, `docs/overlay-adapter-policy.md` removed).
- [ ] **Step 2:** Search for `.agents/docs/mesh-policy.md` and `.agents/docs/repo-runbook-policy.md` references and rewrite to `.agents/doctrine/mesh-policy.md` and `.agents/doctrine/repo-runbook-policy.md`.
