...
|---|---|---|---|---|---|---|---|
| 1 | State/router split and record scripts | ready | [Plan 1](2026-08-09-plan-1-state-router-split.md) | — | — | 9/10 | Creates `review-state.json`, record scripts, `compile_metrics.py`, and refactors `next_node.py` |
