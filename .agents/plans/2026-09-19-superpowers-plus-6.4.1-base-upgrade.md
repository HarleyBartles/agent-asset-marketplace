...
- [ ] **Step 1: Add failing version and inventory assertions**
...
- [ ] **Step 2: Run the focused contract and witness RED**
...
- [ ] **Step 3: Update the canonical basis metadata**
...
- [ ] **Step 5: Commit the basis boundary**
...
- [ ] **Step 3: Merge the upstream guidance through repository authority**
...
- [ ] **Step 5: Commit the low-conflict base changes**
...
- [ ] **Step 1: Add failing Python-helper tests**
...
- [ ] **Step 2: Run the helper contracts and witness RED**
...
- [ ] **Step 4: Implement `task_brief.py` and `review_package.py`**
...
- [ ] **Step 5: Remove dual-shell ownership and update references**
...
- [ ] **Step 6: Run helper and repository contracts GREEN**

Run: `py -3 -m pytest tests/test_subagent_workspace.py tests/test_repo_standards.py tests/test_review_preflight.py tests/test_review_preflight_extensions.py -q`

Expected: PASS.

- [ ] **Step 7: Commit the Python execution engine**
...
- [ ] **Step 1: Add failing workflow contracts and pressure prompts**
...
- [ ] **Step 2: Run the focused tests and baseline pressure scenarios RED**
...
- [ ] **Step 3: Merge shared intent into the three-path owner**
...
- [ ] **Step 4: Add Review Focus and the saved-plan handoff**
...
- [ ] **Step 5: Run contracts and pressure scenarios GREEN**
...
- [ ] **Step 6: Commit the design/planning merge**
...
- [ ] **Step 1: Add failing Native/SDD contracts**
...
- [ ] **Step 2: Run focused contracts and witness RED**
...
- [ ] **Step 3: Rebuild `executing-plans` from the v6.4.1 Native owner**
...
- [ ] **Step 4: Add the upstream Bash task helpers without PowerShell copies**
...
- [ ] **Step 5: Reconcile SDD routing and prompts**
...
- [ ] **Step 7: Commit the execution-engine merge**
...
- [ ] **Step 1: Add failing structure and boundary tests**
...
- [ ] **Step 3: Import the v6.4.1 skill as first-party base content**
...
- [ ] **Step 4: Adapt only the harness and composition seams**
...
- [ ] **Step 6: Commit the diagnostic skill**
...
- [ ] **Step 3: Audit version and stale-route residue**
...
- [ ] **Step 4: Review the whole branch against this plan**
...
- [ ] **Step 5: Complete planning-artifact lifecycle**
...
- [ ] **Step 7: Push and verify Draft PR publication**
