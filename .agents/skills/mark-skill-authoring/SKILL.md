...
Run `scripts/new-skill.sh` or `scripts/new-skill.ps1` before authoring files. Choose custody and lane first, then read [source-grounded authoring](references/source-grounded-authoring.md) and [local and marketplace custody](references/local-and-marketplace-custody.md).
