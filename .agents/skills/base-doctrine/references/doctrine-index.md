...
- `../writing-with-clarity/report-hygiene-checklist.md`: report partitioning, report laundering hard stops, compact coding report shape, and false-GREEN risks (moved to `writing-with-clarity`).
