...
Run `normalize_review_inputs.py --apply` on the scratch directory so every downstream file is plain UTF-8.
...
1. Run:
   ...
   ```
1. Verify every generated file is plain UTF-8 with no BOM.
