...
- The vendored source snapshot is a combined archive (`dotnet.tar.gz`) that contains the `main`
  branches of the .NET documentation repository and the ASP.NET Core documentation repository.
