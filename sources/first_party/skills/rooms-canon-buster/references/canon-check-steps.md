...
Detailed canon-check procedure for `rooms-canon-buster`. The SKILL.md body is a compact router; this reference holds the full ladder, outcome taxonomy, modes, and boundary rules.
...
Do not show a buster queue for one-path corrections unless your human partner asks to see the reasoning.
