...
5. Draft participant-facing text from the investigation packet and your human partner's instructions.
6. Keep source evidence behind the scenes unless your human partner explicitly approves exposing it.
7. If your human partner approves persistence, use only the governed direct-landing lanes in `references/direct-landing.md`.
