...
Upstream plugin roots in this vendor snapshot are governed by the licenses
declared in their `.codex-plugin/plugin.json` manifests and any nested
license files present in the copied upstream tree.

## License summary
- `Apache-2.0`: `6` roots
- `Apache-2.0 AND CC-BY-4.0`: `1` roots
- `MIT`: `161` roots
