"""
Complete Modes View Implementation for claude_ctx_py/tui_textual.py

This file contains all the code needed to add modes functionality to the TUI.
It follows the same pattern as the agents view.

INTEGRATION STEPS:
==================

1. Add to imports (line 33-34):
   from .core.modes import mode_activate, mode_deactivate

2. Add ModeInfo dataclass (after WorkflowInfo, around line 70):
"""
...
"""
3. Add to on_mount() method (add after line 126, before update_view()):
        self.load_modes()

4. Add load_modes() method (after load_workflows(), around line 333):
"""
...
"""
5. Add show_modes_view() method (after show_workflows_view(), around line 427):
"""
...
"""
6. Update update_view() method - add this elif after line 345 (after workflows check):
        elif self.current_view == "modes":
            self.show_modes_view(table)

7. Update action_toggle() method - add this elif after agents block (around line 488):
"""

# Add this as an elif block in action_toggle():
elif self.current_view == "modes":
...
"""
8. Update action_refresh() method - add this elif after line 496 (in the elif chain):
        elif self.current_view == "modes":
            self.load_modes()

COMPLETE! The modes view will now work following the same pattern as the agents view.
"""
