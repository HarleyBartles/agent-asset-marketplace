...
alias:
  - graphql-architect
summary: GraphQL API specialist for schema design, resolvers, and performance tuning.
description: Designs GraphQL schemas, resolvers, and gateway patterns with strong typing,
