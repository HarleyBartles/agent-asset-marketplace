...
alias:
  - protobuf-expert
summary: gRPC and protobuf specialist for high-performance service contracts.
description: Builds gRPC APIs and protobuf schemas with backward-compatible evolution, performance
  tuning, and secure transports.
