...
- Flag any claim that this bundle is still a projection or mirror. The live
  source surface is `plugins/house-skills/skills/`; `gpt-skills/house-skills/`
...
- House Skills updates follow the unversioned current roots in `plugins/house-skills/skills/`.
