...
version: v1
source_id: ambiguity-buster-v1
source_path: gpt-skills/house-skills/ambiguity-buster/SKILL.md
...
- `green` — no material ambiguity remains for the next action.
- `amber` — ambiguity remains but has a safe, explicit assumption or narrow next step.
- `red` — the proposed action would likely choose a meaning, scope, or target the user did not authorize.
- `blocked` — required disambiguating source, authority, or user choice is unavailable.
