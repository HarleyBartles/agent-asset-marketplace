...
This is a GPT/project-side deterministic planning skill. It may create lightweight storyboard, prompt-board, reference-lock, and prompt-safe handoff packets directly. It is not an image-generation execution skill, and its no-generation posture applies only to this planning lane.
