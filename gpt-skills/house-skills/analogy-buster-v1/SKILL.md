...
Given an analogy and the work it is about to support, return:

- `green_holds` — the analogy clarifies the specific question within stated limits.
- `green_drop` — the analogy is unnecessary or safely discarded.
- `amber` — the analogy may help, but limits, source basis, or decision authority need clarification.
- `red` — the analogy is distorting the work or being used as evidence, canon, or authority.
- `blocked` — the source needed to judge the analogy is unavailable.
...
- whether to keep, limit, revise, or drop it;
