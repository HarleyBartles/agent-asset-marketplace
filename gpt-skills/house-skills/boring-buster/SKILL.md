...
name: boring-buster
version: v1
source_id: boring-buster-v1
source_path: gpt-skills/house-skills/boring-buster/SKILL.md
...
- `green` — boring enough to execute in the intended lane.
- `amber` — close, but needs a named repair before execution.
- `red` — too broad, clever, hidden, authority-confused, or unfalsifiable to execute safely.
- `blocked` — required source, authority, environment, or dependency is missing.
