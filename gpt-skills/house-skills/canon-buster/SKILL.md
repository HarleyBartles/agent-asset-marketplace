...
name: canon-buster
version: v1
source_id: canon-buster-v1
source_path: gpt-skills/house-skills/canon-buster/SKILL.md
...
- `green` — the claim or action is grounded in the current authoritative canon/source route and does not drift.
- `amber` — the claim may be valid, but source basis, authority, wording, or mutation route needs repair.
- `red` — the claim contradicts canon, invents canon, collapses ambiguity, or uses the wrong authority.
- `blocked` — the authoritative canon/source surface is unavailable or the required authority is missing.
